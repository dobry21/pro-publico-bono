...
| [stella](https://github.com/stella/stella) | Apache-2.0 | TypeScript / Rust | Open-source legal workspace for legal teams, currently in beta; supports matter organization, document storage, full-text search, versioning, granular access control, tabular document review, anonymization support, self-hosting, and a hosted preview | [GitHub](https://github.com/stella/stella) · [Site](https://stll.app) |
