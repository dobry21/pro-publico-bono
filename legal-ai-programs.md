...
A curated list of interesting tools, frameworks, and open-source projects at the intersection of legal practice and AI. Divided into two sections: dedicated Legal AI infrastructure tools (orchestration, data, guardrails) and general-purpose open-source projects useful in legal contexts.

---

## Part 1 — Dedicated Legal AI Tools

Tools built specifically for legal AI workflows, covering the three layers of a production system: **orchestration** (agents, pipelines), **data** (RAG, document processing), and **guard** (compliance, hallucination control, policy enforcement).

| Name | Layer | License | Language | Description | Links |
|------|-------|---------|----------|-------------|-------|
| [LlamaIndex](https://www.llamaindex.ai/) | Data | MIT | Python | RAG framework for ingesting, indexing, and querying legal documents (contracts, case law, filings) | [GitHub](https://github.com/run-llama/llama_index) |
| [Haystack](https://haystack.deepset.ai/) | Data | Apache-2.0 | Python | End-to-end NLP pipelines for document search and Q&A; widely used for legal document retrieval | [GitHub](https://github.com/deepset-ai/haystack) |
| [Docling](https://ds4sd.github.io/docling/) | Data | MIT | Python | IBM document parsing library; converts PDFs, DOCX, and scanned contracts into structured data | [GitHub](https://github.com/DS4SD/docling) |
| [Unstructured](https://unstructured.io/) | Data | Apache-2.0 | Python | Preprocessing library for extracting text from legal PDFs, court filings, and HTML pages | [GitHub](https://github.com/Unstructured-IO/unstructured) |
| [LangGraph](https://langchain-ai.github.io/langgraph/) | Orchestration | MIT | Python | Stateful, graph-based agent orchestration; ideal for multi-step legal research and review workflows | [GitHub](https://github.com/langchain-ai/langgraph) |
| [CrewAI](https://www.crewai.com/) | Orchestration | MIT | Python | Multi-agent framework for assembling specialist legal AI agents (researcher, drafter, reviewer) | [GitHub](https://github.com/crewAIInc/crewAI) |
| [AutoGen](https://microsoft.github.io/autogen/) | Orchestration | MIT | Python | Microsoft's conversational multi-agent framework; supports legal document drafting pipelines | [GitHub](https://github.com/microsoft/autogen) |
| [Agno](https://docs.agno.com/) | Orchestration | MPL-2.0 | Python | Lightweight agent framework with built-in memory, tools, and knowledge; fast multi-agent orchestration | [GitHub](https://github.com/agno-agi/agno) |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) | Guard | Apache-2.0 | Python | NVIDIA's toolkit for adding programmable guardrails (topical, safety, factual) to LLM applications | [GitHub](https://github.com/NVIDIA/NeMo-Guardrails) |
| [Guardrails AI](https://www.guardrailsai.com/) | Guard | Apache-2.0 | Python | Validates and corrects LLM outputs against schemas and rules; useful for contract clause extraction | [GitHub](https://github.com/guardrails-ai/guardrails) |
| [Garak](https://garak.ai/) | Guard | Apache-2.0 | Python | LLM vulnerability scanner; red-teaming tool to probe legal AI systems for hallucination and bias | [GitHub](https://github.com/NVIDIA/garak) |
| [LangFuse](https://langfuse.com/) | Orchestration | MIT / EE | Python / TS | Open-source LLM observability — traces, evals, and cost tracking for legal AI pipelines | [GitHub](https://github.com/langfuse/langfuse) |
| [OpenContracts](https://github.com/JSv4/OpenContracts) | Data | Apache-2.0 | Python | Open-source legal document annotation and analysis platform built on Django + GraphQL | [GitHub](https://github.com/JSv4/OpenContracts) |
| [Spacy-LLM](https://spacy.io/usage/large-language-models) | Data | MIT | Python | Integrates LLMs into spaCy NLP pipelines for legal NER (parties, dates, clauses, jurisdiction) | [GitHub](https://github.com/explosion/spacy-llm) |
...
- **Layer legend (Part 1):** `Orchestration` = agent/pipeline coordination · `Data` = ingestion, parsing, RAG · `Guard` = safety, policy, output validation
